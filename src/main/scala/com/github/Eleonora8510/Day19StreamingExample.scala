...
object Day19StreamingExample extends App {
  println(s"Exploring Streaming in Scala version: ${util.Properties.versionNumberString}")
  ...
  println(s"We got ${staticDataFrame.count()} rows of data !") // remember count goes across all partitions
