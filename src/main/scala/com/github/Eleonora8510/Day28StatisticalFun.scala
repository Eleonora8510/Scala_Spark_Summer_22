...
import org.apache.spark.sql.functions.{collect_list, collect_set, corr, covar_pop, covar_samp, expr, kurtosis, lit, mean, skewness, stddev_pop, stddev_samp, var_pop, var_samp}

object Day28StatisticalFun extends App {
  println("Ch 7: Statistics Functions")
...
//  numDF.withColumn("nmean", expr("avg(nums)"))
